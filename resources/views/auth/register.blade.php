                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="aadhar_card" type="file" class="form-control @error('aadhar_card') is-invalid @enderror" name="aadhar_card" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="pan_card" type="file" class="form-control @error('pan_card') is-invalid @enderror" name="pan_card" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="driving_voter_card" type="file" class="form-control @error('driving_voter_card') is-invalid @enderror" name="driving_voter_card" required>
