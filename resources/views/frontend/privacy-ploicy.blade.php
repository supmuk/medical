    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12">
          <h1 class="title mb-0">Privacy <span>Policy</span></h1>
        </div>
      </div>
    </div>
</section>
    ...
    <div class="container">
      ...
      <div class="row mt-3">
        <div class="col-lg-12 col-md-12">
          ...
          <h5 class="mt-5 text-theme">Use of User Information.</h5>
          ...
          <h5 class="mt-5 text-theme">Disclosure of User Information.</h5>
